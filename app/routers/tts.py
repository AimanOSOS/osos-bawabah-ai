...
async def clone_voice_text_to_speech(
    text: str = Form(..., description="The new text to synthesize in the cloned voice."),
    prompt_wav: UploadFile = File(..., description="Prompt audio file (.wav) for voice cloning."),
    prompt_text: str = Form(..., description="The exact text transcription of the prompt audio.")
    ):
    """
